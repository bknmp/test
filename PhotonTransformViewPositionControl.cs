...
public class PhotonTransformViewPositionControl
{
	...
	public Vector3 UpdatePosition(Vector3 currentPosition)
	{
		...
		if (m_Model.TeleportEnabled && (currentPosition - GetNetworkPosition()).sqrMagnitude > m_Model.TeleportIfDistanceGreaterThan * m_Model.TeleportIfDistanceGreaterThan)
		{
	...
	{
		if (m_Model.ExtrapolateOption == PhotonTransformViewPositionModel.ExtrapolateOptions.Disabled)
		{
			return Vector3.zero;
		}
		...
		case PhotonTransformViewPositionModel.ExtrapolateOptions.EstimateSpeedAndTurn:
			result = (m_NetworkPosition - GetOldestStoredNetworkPosition()) * PhotonNetwork.sendRateOnSerialize * num;
			break;
		}
		return result;
	}
